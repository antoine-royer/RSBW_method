...
RSBW_1_perturber.ipynb (resp. RSBW_2_perturbers.ipynb) allow for calculations of the exact and approximated energies of a simple system, made up of two model states and one (resp. two) perturber(s) state(s).
